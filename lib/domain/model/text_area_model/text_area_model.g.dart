...
part of 'text_area_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class TextAreaModelAdapter extends TypeAdapter<TextAreaModel> {
  @override
  final int typeId = 11;

  @override
  TextAreaModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return TextAreaModel(
      maxLength: fields[13] as int,
      minLength: fields[14] as int,
  ...
  @override
  void write(BinaryWriter writer, TextAreaModel obj) {
    writer
      ..writeByte(14)
      ..writeByte(13)
      ..write(obj.maxLength)
