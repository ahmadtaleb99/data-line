...
class StarRatingAdapter extends TypeAdapter<StarRating> {
  @override
  final int typeId = 51;

  @override
  StarRating read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, StarRating obj) {
    writer
      ..writeByte(11)
      ..writeByte(1)
      ..write(obj.label)
