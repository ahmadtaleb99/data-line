...
import 'checkbox_group_widget.dart';
import '../model/DropDownItem.dart';
import 'form_element_widget.dart';


class ChildDropDownWidget extends FormElementWidget {
  ChildDropDownWidget({Key? key,
    this.visible = false,
    required this.label,
  ...
  ChildDropDownWidget copyWith({String? label,
    String? value,
    bool? deactivated,
    bool? required,
    bool? isHidden,
